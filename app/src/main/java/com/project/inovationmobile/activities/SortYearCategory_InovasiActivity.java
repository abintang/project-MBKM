...
public class SortYearCategory_InovasiActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        url = "https://api.koys.my.id/inovasi/kategori/" + idCategory+ "/tahun/" + tahun;
        ...
        nestedScrollView = findViewById(R.id.scrollView2);
        RequestQueue queue = Volley.newRequestQueue(SortYearCategory_InovasiActivity.this);
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(SortYearCategory_InovasiActivity.this, "Fail to get data..", Toast.LENGTH_SHORT).show();
        ...
        searchButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(SortYearCategory_InovasiActivity.this, SearchInovasiActivity.class);
    ...
    private void getData(int page, int limit){
        String url2 = "https://api.koys.my.id/inovasi/kategori/"+ idCategory +"/tahun/"+ tahun +"/paginate?page=" + page;
